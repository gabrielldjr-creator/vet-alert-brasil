...
Plataforma de análise agregada exclusiva para médicos-veterinários convidados. O primeiro acesso é feito por link mágico enviado ao e-mail profissional; depois disso, a sessão invisível é mantida pelo Firebase Auth.
...
- **Registros observacionais anônimos**: estrutura curta (espécie, categoria, fonte suspeita, região, nota curta opcional) para facilitar agrupamentos estatísticos sem expor dados sensíveis.

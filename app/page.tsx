      ...
      <section className="space-y-4">
        ...
        <Card className="space-y-3 border-slate-200 p-6">
          <ul className="space-y-2 text-sm text-slate-700">
            <li>• Registros atendidos de forma isolada não revelam padrões agregados regionais</li>
            ...
            <li>• Entre o registro individual e o laudo, há um intervalo informacional</li>
          </ul>
        </Card>
      </section>
      ...
      <section className="space-y-4">
        ...
        <Card className="space-y-4 border-slate-200 p-6">
          <ol className="space-y-2 text-sm text-slate-700">
            <li>1. Registro clínico individual</li>

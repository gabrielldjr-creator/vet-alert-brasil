...
const links = [
  { href: "/alerta/novo", label: "Sinal Veterinário" },
  { href: "/agro-signals/new", label: "Sinal de Campo" },
  { href: "/global-alerts-dashboard", label: "Inteligência de Alertas" },
];
    ...
    <header className="sticky top-0 z-20 border-b border-emerald-50 bg-white/80 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-10">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            Como usar os sinais regionais de forma ética
          </Link>
        </div>
      </div>
    </header>
